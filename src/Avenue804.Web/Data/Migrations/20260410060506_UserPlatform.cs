...
{
    /// <inheritdoc />
    public partial class UserPlatform : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyRatings_PropertyListings_ListingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedProperties_PropertyListings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "PropertyListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyRatings_ListingId",
                table: "PropertyRatings",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyRatings_UserId_ListingId",
                table: "PropertyRatings",
                columns: new[] { "UserId", "ListingId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SavedProperties_ListingId",
                table: "SavedProperties",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedProperties_UserId_ListingId",
                table: "SavedProperties",
                columns: new[] { "UserId", "ListingId" },
                unique: true);
        }
