...
# Targeted files: layouts changed -> compiled Views DLL must update; favicons are new/changed.
$relPaths = @(
    "Avenue804.Web.dll",
    "Avenue804.Web.pdb",
    "wwwroot/favicon.ico",
    "wwwroot/manifest.json",
    "wwwroot/assets/img/brand/favicon-16.png",
    "wwwroot/assets/img/brand/favicon-32.png",
    "wwwroot/assets/img/brand/favicon-48.png",
    "wwwroot/assets/img/brand/favicon-180.png",
    "wwwroot/assets/img/brand/favicon-192.png",
    "wwwroot/assets/img/brand/favicon-512.png"
)

Write-Host "Placing app_offline.htm..." -ForegroundColor Yellow
$tmpOffline = [System.IO.Path]::GetTempFileName()
Set-Content $tmpOffline -Value "<!DOCTYPE html><html><body><h1>Updating favicon...</h1></body></html>" -Encoding UTF8
...
foreach ($rel in $relPaths) {
    ...
    $out = curl.exe --silent --user $userArg --ftp-create-dirs --upload-file $local $remote 2>&1
